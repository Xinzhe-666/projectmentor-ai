...
import { getAiStatus } from '@/v46/api/ai'
import { getDashboardSummary } from '@/v46/api/dashboard'
import DemoWorkflow from '@/v46/components/DemoWorkflow.vue'
import EmptyState from '@/v46/components/EmptyState.vue'
import { useUserStore } from '@/stores/user'
import type { AiStatus, DashboardSummary, InterviewSessionListItem, Project, ReportListItem } from '@/v46/types/api'
