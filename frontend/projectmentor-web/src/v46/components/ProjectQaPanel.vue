...
import { askProjectQuestion, deleteProjectQaRecord, getProjectQaHistory } from '@/v46/api/projectQa'
...
import type { ProjectQaHistoryRecord, ProjectQaResponse } from '@/v46/types/api'
...
.qa-input-shell {
  ...
  animation: v46-commandGlow 6s ease-in-out infinite;
}
