...
import AppFooter from '@/v46/components/AppFooter.vue'
import DemoWorkflow from '@/v46/components/DemoWorkflow.vue'
import FeedbackDialog from '@/v46/components/FeedbackDialog.vue'
import DonateDialog from '@/v46/components/DonateDialog.vue'
...
.landing-page {
  min-height: 100vh;
  animation: v46-pageFadeIn 420ms ease both;
}
